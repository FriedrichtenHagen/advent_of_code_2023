...
def extrapolate_history(history):
    ...
    for row_index, row in enumerate(reversed(two_dimensional_difference_list)):
        if row_index == len(two_dimensional_difference_list)-1:
        ...
        # dfg
        # ....
        difference = reversed(two_dimensional_difference_list)[row_index][-1]
        a = reversed(two_dimensional_difference_list)[row_index + 1][-1]
        c = a + difference
        reversed(two_dimensional_difference_list)[row_index + 1].append(c)
    print('Updated list')
...
example_history = [5, 4, 13, 36, 73, 128, 229, 462, 1032, 2399, 5601, 12970, 29584, 66034, 143565, 303669, 626287, 1264754, 2512757, 4930676, 9578227]
